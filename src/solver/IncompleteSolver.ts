...
// ---------------------------------------------------------------------------
// IncompleteSolver — mirrors solver/IncompleteSolver.java
//
// Always returns null — matching the Java source where getStep() returns null
// for INCOMPLETE.  The INCOMPLETE type is used as a tag on steps that were
// produced by an external source (e.g. import), not found by the solver.
// ---------------------------------------------------------------------------

export class IncompleteSolver extends AbstractSolver {
